...
```text
RSS ────┐
        ├── collectors → Article → SQLite repository → NEW / DUPLICATE
arXiv ──┘
```
...
| `requirements.txt` | `feedparser` cho RSS và Atom; `sqlite3` thuộc thư viện chuẩn. |
...
5. **Phase 5:** Web Search collector.
